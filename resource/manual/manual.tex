...
\begin{refsection}
  ...
  \begin{summary}
    \input{input/forsyde-atom-abstract}
  \end{summary}
  \minitoc
  \input{input/forsyde-atom}
  \input{input/ForSyDe-Atom}
  \input{input/ForSyDe-Atom-ExB}
  \input{input/ForSyDe-Atom-ExB-Absent}
  \input{input/ForSyDe-Atom-MoC}
  ...
  \input{input/ForSyDe-Atom-MoC-SDF}
  \input{input/ForSyDe-Atom-MoC-Time}
  \input{input/ForSyDe-Atom-MoC-TimeStamp}
  \input{input/ForSyDe-Atom-Skeleton}
  \input{input/ForSyDe-Atom-Skeleton-Vector}
